...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	{
		Song otherSong = other instanceof Song ? (Song) other : null;
		return other != null && super.equals(otherSong) && this.composer.equals(otherSong.composer) && this.artist.equals(otherSong.artist);
	}
	...
	{
		// assuming ignore cases - some songs may have lower cases or upper cases for stylistic reasons
