...
public class ImageHolder extends Actor
{
    ...
    private ArrayList<GreenfootImage> lastImages;
    ...
    {
        lastImages = new ArrayList<GreenfootImage>();
    ...
    public void restoreLastImage() {
        System.out.println(lastImages.size());
        System.out.println(lastImages.get(0));
        setNewImage(lastImages.get(0));
        lastImages.remove(0);            
    }
    
    public ArrayList<GreenfootImage> lastImages() {
        return lastImages;
    }
    
    public void updateLastImages() {
        lastImages.add(0, Processor.createGreenfootImageFromBI(this.getBufferedImage()));
    }
}
