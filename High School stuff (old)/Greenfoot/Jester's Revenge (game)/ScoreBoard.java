...
public class ScoreBoard extends Actor
{
    ...
    // The main text color:
    private static final Color MAIN_COLOR = new Color(0xF0, 0x40, 0x40); // orange-y
    // The score color:
    private static final Color SCORE_COLOR = new Color(0x60, 0x60, 0x60); // dark grey-y
    // The background colors:
    private static final Color BACKGROUND_COLOR = new Color(0xB0, 0x40, 0x40, 0xB0);
