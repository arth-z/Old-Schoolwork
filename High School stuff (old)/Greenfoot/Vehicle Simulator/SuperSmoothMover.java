...
public abstract class SuperSmoothMover extends Actor
{
    ...
    // method added to facilitate the vanishing of vehicles and the spawning of a skull effect as they are removed
    public void die() {
        getWorld().addObject(new DeathEffect(), this.getX(), this.getY());
