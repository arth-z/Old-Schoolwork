...
public class AudioBook extends AudioContent
{
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	{
		AudioBook otherBook = other instanceof AudioBook ? (AudioBook) other : null;
		return other != null && super.equals(otherBook) && this.author.equals(otherBook.author) && this.narrator.equals(otherBook.narrator);
	}
